...
public class Model2004Strategy extends Strategy {

    @Override
    public int calculateFrequentRentalPoints(Rental rental) {
	Integer fpr = ItemFPR.XBOX_M2004;
	System.out.println("Frequent Renter Points for Xbox-Model2004: " + fpr);
	return fpr;
    }

    @Override
    public Double calculateRentalPrice(Rental rental) {
	Double amount = ItemRentPrice.XBOX_M2004;
	System.out.println("Rental Amount for Xbox-Model2004: " + amount);
	return amount;
    }

    @Override
    public Double calculatePurchasePrice(Sale sale) {
	Double amount = ItemSalePrice.XBOX_M2004;
	System.out.println("Sale Amount for Xbox-Model2004: " + amount);
	return amount;
    }
